...
execute store result storage skills.culinary.bonus nutrition double 0.01 run scoreboard players operation apply_culinary_skill skills.culinary *= cabbage_soup_nutrition skills.math

scoreboard players operation apply_culinary_skill skills.culinary = @s skills.culinary
scoreboard players operation apply_culinary_skill skills.culinary += floor skills.math
execute store result storage skills.culinary.bonus saturation double 0.01 run scoreboard players operation apply_culinary_skill skills.culinary *= cabbage_soup_saturation skills.math
