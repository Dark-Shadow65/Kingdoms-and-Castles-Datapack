...
execute if predicate skills:can_parry unless score @s skills.combat.parry_cooldown matches 0.. unless items entity @s weapon.offhand * run item modify entity @s weapon.mainhand skills:combat/set_able_to_parry
execute if predicate skills:can_parry if items entity @s weapon.offhand * run item modify entity @s weapon.mainhand skills:combat/set_unable_to_parry
...
execute if items entity @s weapon.mainhand *[minecraft:custom_data~{"skill":"axe"}] store result score @s skills.combat.parry_break run scoreboard players get @s skills.axes.parry_break
execute if items entity @s weapon.mainhand *[minecraft:custom_data~{"skill":"axe"}] store result score parry_break_scalar skills.math run data get entity @s SelectedItem.components."minecraft:custom_data".parry_break_scalar 75
execute if items entity @s weapon.mainhand *[minecraft:custom_data~{"skill":"axe"}] unless items entity @s weapon.offhand * store result score parry_break_scalar skills.math run data get entity @s SelectedItem.components."minecraft:custom_data".parry_break_scalar 100
...
execute if items entity @s weapon.mainhand *[minecraft:custom_data~{"skill":"axe"}] run scoreboard players operation @s skills.combat.parry_break /= floor skills.math
