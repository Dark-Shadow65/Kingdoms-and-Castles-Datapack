advancement revoke @s only skills:forge_items/craft_iron_hoe
scoreboard players add @s skills.blacksmithing.xp 5

data modify storage skills.blacksmithing.bonus type set value "minecraft:iron_hoe"
data modify storage skills.blacksmithing.bonus name set value "Iron Hoe"
data modify storage skills.blacksmithing.bonus efficient_on set value "\"#minecraft:mineable/shovel\""
data modify storage skills.blacksmithing.bonus attack_speed_debuff set value -3.1
...
execute store result storage skills.blacksmithing.bonus efficiency float 0.001 run scoreboard players operation apply_blacksmith_skill skills.blacksmithing.efficiency_bonus *= iron_tool_efficiency_floor skills.math
...
data modify storage skills.blacksmithing.bonus parry_break_scalar set value 1
