advancement revoke @s only skills:forge_items/craft_iron_shovel
scoreboard players add @s skills.blacksmithing.xp 5

data modify storage skills.blacksmithing.bonus type set value "minecraft:iron_shovel"
data modify storage skills.blacksmithing.bonus name set value "Iron Shovel"
