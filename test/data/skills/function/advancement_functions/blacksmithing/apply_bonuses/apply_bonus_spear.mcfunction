advancement revoke @s only skills:forge_items/craft_spear
...
data modify storage skills.blacksmithing.bonus name set value "Spear"
...
data modify storage skills.blacksmithing.bonus reach set value 1.65
