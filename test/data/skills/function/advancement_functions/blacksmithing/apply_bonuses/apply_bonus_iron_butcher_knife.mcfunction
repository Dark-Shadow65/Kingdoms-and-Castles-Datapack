advancement revoke @s only skills:forge_items/craft_iron_butcher_knife
scoreboard players add @s skills.blacksmithing.xp 5

data modify storage skills.blacksmithing.bonus name set value "Knife"
...
data modify storage skills.blacksmithing.bonus reach set value 0.8
