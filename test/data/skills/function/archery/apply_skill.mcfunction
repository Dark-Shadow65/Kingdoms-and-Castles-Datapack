...
execute if predicate skills:archery/holding_longbow run tag @e[type=arrow,tag=!skill_applied,limit=1,sort=nearest,nbt={item:{components:{"minecraft:custom_model_data":2}}}] add piercing
