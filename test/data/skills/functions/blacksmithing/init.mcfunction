...
scoreboard players set one skills.blacksmithing.skillmath 1
scoreboard players set axe_sharpness_floor skills.blacksmithing.skillmath 200
...
scoreboard players set flint_durability_floor skills.blacksmithing.skillmath 100

scoreboard players set warhammer_damage_floor skills.blacksmithing.skillmath 5
