advancement revoke @s only skills:forge_items/craft_iron_axe
scoreboard players add @s skills.blacksmithing.xp 5

data modify storage skills.blacksmithing.bonus type set value "minecraft:iron_axe"
data modify storage skills.blacksmithing.bonus name set value "Iron Axe"
...
execute store result storage skills.blacksmithing.bonus efficiency float 0.01 run scoreboard players operation apply_blacksmith_skill skills.blacksmithing.efficiency_bonus *= iron_tool_efficiency_floor skills.blacksmithing.skillmath
