...
$execute positioned ~$(x) ~-2 ~$(z) if block ~ ~-1 ~ farmland run fill ~ ~-1 ~ ~ ~-1 ~ dirt
$execute positioned ~$(x) ~-1 ~$(z) if block ~ ~-1 ~ farmland run fill ~ ~-1 ~ ~ ~-1 ~ dirt
$execute positioned ~$(x) ~ ~$(z) if block ~ ~-1 ~ farmland run fill ~ ~-1 ~ ~ ~-1 ~ dirt
$execute positioned ~$(x) ~1 ~$(z) if block ~ ~-1 ~ farmland run fill ~ ~-1 ~ ~ ~-1 ~ dirt
$execute positioned ~$(x) ~2 ~$(z) if block ~ ~-1 ~ farmland run fill ~ ~-1 ~ ~ ~-1 ~ dirt
